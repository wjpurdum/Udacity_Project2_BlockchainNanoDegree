...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Mariah Carey', starId1, {from: accounts[0]});
    await instance.createStar('Janis Joplin', starId2, {from: accounts[1]});
